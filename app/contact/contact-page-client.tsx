...
const expectations = [
  {
    ...
    copy: "A focused strategy call and consultation to understand your operating model and current planning friction.",
  },
  {
    icon: Database,
        ...
        <section className="mx-auto max-w-7xl">
          <div className="max-w-3xl">
            ...
            <p className="section-copy mt-6 max-w-2xl">
              Tell us about your business and we will identify where ecommerce
              forecasting, inventory planning, revenue visibility, and
              operational decision intelligence can help.
            </p>
          </div>
        </section>
